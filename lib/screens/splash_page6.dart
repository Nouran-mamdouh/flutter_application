...
import 'package:flutter_application_1/screens/splash_page7.dart';

class SplashPage6 extends StatefulWidget {
  const SplashPage6({super.key});

  @override
  State<SplashPage6> createState() => _SplashPage6State();
}
              ...
              children: [
                const ClipRRect(
                  ...
                  child: Padding(
                    ...
                    child: Image(
                      image: AssetImage('Images/image 33 (1).png'),
                      height: 450,
                      width: 700,
                ...
                const Row(
                  children: [
                    Padding(
                      ...
                      child: Center(
                        child: Text(
                          "Get the best exercise programs ",
                          style: TextStyle(
                            fontSize: 23,
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                              builder: (builder) => const SplashPage7()));
                    },
                    child: Container(
                      width: 94,
                      height: 36,
